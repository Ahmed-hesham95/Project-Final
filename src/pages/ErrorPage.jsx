...
export default function ErrorPage() {
    return (
        <div className='h-dvh w-full flex justify-center items-center'>
            <div className='w-1/2 flex flex-col gap-12 justify-center items-center shadow-[0_0_30px_rgba(0,0,0,0.1)] border border-gray-300 rounded-4xl py-6 px-4 md:py-12 md:px-24'>
